...
#define SFSLITE_VERSION_MAJOR 0
#define SFSLITE_VERSION_MINOR 8
#define SFSLITE_VERSION_PATCHLEVEL 17
#define SFSLITE_VERSION_PRE 4
...
#define SFSLITE_PATCHLEVEL_STR "0.8.17pre4"
