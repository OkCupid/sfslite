...
public:
  ...
  void enforce_cceoc (const char *loc);
  ...
  //
  // these end of lines will be generated by the compiler, so they
  // can safely be passed around as const char's.  in stress testing,
  // it actually matters that we don't allocate strings ever iteration.
  //
  void end_of_scope_checks (const char *l);
